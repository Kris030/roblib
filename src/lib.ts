...
export const init = async (ip: string) => {
    ...
    // connected to server
    return new Promise<typeof socket>(res =>
...
/**
 * A robot elején lévő LEDek színét állítja
...
/**
 * a robot rezgőmotorját irányítja
...
/**
 * vár `x` milliszekundumot, az `await` kulcsszóval kell használni
